...
import pw.avvero.leet.year2023.year2023_09.Problem212
...
class Problem212Tests extends Specification {
    ...
    def "test8"() {
        expect:
        new Problem212().findWords(board, words).sort() == ["oath","oathk","oathf","oathfi","oathfii","oathi","oathii","oate","eat"].sort()
        where:
        board = [
                ["o","a","a","n"],
                ["e","t","a","e"],
        ...
        words = ["oath","pea","eat","rain","oathi","oathk","oathf","oate","oathii","oathfi","oathfii"] as String[]
    }

    @Unroll
    def "test53"() {
        expect:
        new Problem212().findWords(board, words).sort() == ["oa","oaa"].sort()
        where:
        board = [
                ["o","a","b","n"],
                ["o","t","a","e"],
    ...
    def "test100"() {
        ...
        words = ["ababababaa","ababababab","ababababac","ababababad","ababababae","ababababaf","ababababag","ababababah",
                 ...
                 "ababababzw","ababababzx","ababababzy","ababababzz"] as String[]
    }
}
